...
export function AuthLayout({ children }: AuthLayoutProps) {
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-background overflow-hidden">
      <div className="hidden md:flex md:w-[55%] bg-primary-5 items-center justify-center p-12 relative">
        ...
        >
          ...
          <img
            className="relative w-full h-auto rounded-[60px] shadow-[0_32px_64px_-12px_rgba(184,198,219,0.4)] border-12 border-white/80"
            src={auraImage}
            alt=""
          />
          ...
          <motion.div
            ...
            className="absolute -top-10 -right-10 w-32 h-32 bg-white rounded-4xl shadow-xl flex items-center justify-center p-6 border border-slate-50"
          >
          ...
          <motion.div
            ...
            className="absolute -bottom-10 -left-10 w-28 h-28 bg-white rounded-4xl shadow-xl flex items-center justify-center p-6 border border-slate-50"
          >
